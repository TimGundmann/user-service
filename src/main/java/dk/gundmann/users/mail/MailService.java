...
class MailService implements IMailService {
    ...
    public void sendPasswordChangeMail(String email) {
    	MailBuilder.aBuilder(emailSender)
			...
			.to(email)
			.text("<html><body><h2>Nyt password</h2> <p>Klike på linket for at ændre dit password <a href=\"https://busroskilde.dk/#/password/" + makeLinkToken(email, TWO_HOURS) + "\">Password link</a></p></body></html>")
			.send();
    }
    ...
    public void sendActivationMailToAdmin(User user, Collection<String> adminMails) {
    	MailBuilder.aBuilder(emailSender)
    		...
    		.text("<html><body>"
        			...
        			+ "<p>" + user.getName() + "</p>" 
        			+ "<p><a href=\"https://busroskilde.dk/#/activate/" + makeLinkToken(user.getEmail(), TWO_DAYES) + "\">Aktiver brugeren</a></p>"
	...
	private String makeMessageForPlanChange(String type) {
		return "<html><body>"
    			...
    			+ "<p><a href=\"https://busroskilde.dk/#/home/plans/" + type + "\">Se ændringen her</a></p>"
    			+ "<p>Med venlig hilsen</p>"
    			+ "<p>Bus roskilde</p>"
    			+ "</body></html>";
	}
	...
	private String makeMessageForNews(String type) {
		return "<html><body>"
    			...
    			+ "<p><a href=\"https://busroskilde.dk/#/home/news\">Se nyheden her</a></p>"
    			+ "<p>Med venlig hilsen</p>"
    			+ "<p>Bus roskilde</p>"
    			+ "</body></html>";
	}
